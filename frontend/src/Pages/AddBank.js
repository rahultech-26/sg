                          ...
                          <div className="row g-3">
                            ...
                            <div className="col-md-6">
                              <div className="row">
                                ...
                                <div className="col-sm-9">
                                  <input
                                  value={postList.ifscCode}
                                   onChange={(e)=>setPostList({...postList,ifscCode:e.target.value})}
                                    type="text"
                            ...
                            <div className="col-md-6">
                              <div className="row">
                                ...
                                <div className="col-sm-9">
                                  <input
                                  value={postList.branch}
                                   onChange={(e)=>setPostList({...postList,branch:e.target.value})}
                                    type="text"
                                    className="form-control"
                                    placeholder="Branch"
                                  />
