...
function AddBrand(props) {
  ...
  const putData = () => {
    axios
      .put(baseUrl + "brand/" + postList._id,
        postList,
  ...
  const delData = () => {
    axios.delete(baseUrl + "brand/" + postList._id).then(() => {
      props.propBrandFn();
      refreshFn();
    });
  };
                ...
                <div className="card accordion-item">
                      ...
                      <div className="row g-3">
                        <div className="col-md-4">
                          <select
                            ...
                            value={postList.brand}
                            onChange={(e) =>
                              setPostList(
                                props.brandList.filter(
                          ...
                          >
                            ...
                            {props.brandList.map((i) => (
                              <option value={i._id}>{i.brandName}</option>
                            ))}
                          </select>
                        </div>
                  ...
                  <div className="mt-4 text-center">
                    ...
                    ref={seven}
                      ...
                      onClick={() => props.setIsAppBrand(false)}
                      type="reset"
