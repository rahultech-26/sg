...
function AddParty(props) {
  ...
  const putData = () => {
    axios
      .put(baseUrl + "tulai/" + postList._id,
        postList,
  ...
  const delData = () => {
    axios.delete(baseUrl + "tulai/" + postList._id).then(() => {
      props.propTulaiFn();
      refreshFn();
    });
  };
                ...
                <div className="card accordion-item">
                      ...
                      <div className="row g-3">
                        <div className="col-md-4">
                          ...
                          >
                            ...
                            {props.tulaiList.map((i) => (
                              <option value={i._id}>{i.tulaiId}</option>
                            ))}
                          </select>
                        </div>
                  ...
                  <div className="mt-4 text-center">
                    ...
                    ref={twelve}
                      ...
                      onClick={() => props.setIsAppTulai(false)}
                      type="reset"
