...
function AddParty(props) {
  ...
  const postData = () => {
    axios
      .post(baseUrl + "undergroup", postList)
      .then(() => {
        props.propUnderGroupFn();
        refreshFn();
      });
  };
  const putData = () => {
    axios
      .put(baseUrl + "undergroup/" + postList._id,
        postList,
  ...
  const delData = () => {
    axios.delete(baseUrl + "undergroup/" + postList._id).then(() => {
      props.propUnderGroupFn();
      refreshFn();
    });
  };
                ...
                <div className="card accordion-item">
                        ...
                        <div className="col-md-8">
                              <div className="row">
                                ...
                                <div className="col-sm-9">
                                  ...
                                  ref={one}
                                  value={postList.undergroup}
                                   onChange={(e)=>setPostList({...postList,undergroup:e.target.value})}
                                    type="text"
                  ...
                  <div className="mt-4 text-center">
                    ...
                    ref={six}
                      ...
                      onClick={() => {
                        props.propUnderGroupFn()
                        props.setIsAppUnderGroup(false)
                      }}
                      type="reset"
