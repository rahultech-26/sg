...
const getBankData=()=>{
  axios.get(baseUrl + "bank").then((res)=>setBankData(res.data.data))
}
const delFn=(x)=>{
  axios.delete(baseUrl + "bank/"+x).then(()=>getBankData())
}
  return (
    <>
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="">
                              <a
                              onClick={()=>{
                                localStorage.setItem("editBankData",JSON.stringify(i))
                                navigate("/EditBank")
                              }}
                                style={{
                                  color: "#696cff",
