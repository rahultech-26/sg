...
function AddParty() {
  ...
  const data= localStorage.getItem("editProduceTypeData")
  const parshProduceData= JSON.parse(data)
  const [postList,setPostList]=useState(parshProduceData)
  const postData=()=>{
    axios.put(baseUrl + "produceType/"+postList._id,postList).then(()=>navigate("/ProduceTypeTable"))
  }
  return (
    <div>
                      ...
                      >
                        ...
                        <div className="accordion-body">
                          ...
                          <div className="mt-4 text-center">
                            ...
                            <button
                            onClick={()=>navigate("/ProduceTypeTable")}
                              type="reset"
