...
function AddThirdPartyPurchase() {
    useEffect(()=>{getBroker();getParty()},[])
    const navigate=useNavigate()
    const localData = localStorage.getItem("editThirdPartyPurchaseData")
    ...
    const postDataFn =()=>{
        ...
        setIsSubmit(false)
        axios.put(baseUrl+"mandipurchase/"+postData._id,postData).then(()=>navigate("/ThirdPartyPurchase"))}
                      ...
                      <div id="collapseDeliveryAddress" className="accordion-collapse collapse show" aria-labelledby="headingDeliveryAddress" data-bs-parent="#collapsibleSection">
                        ...
                        <div className="accordion-body">
                          ...
                          <div className="mt-4 text-center">
                            ...
                            <button type="reset" className="btn btn-label-secondary" onClick={() => navigate("/ThirdPartyPurchase")}>Cancel</button>
                          </div>
                        </div>
                      </div>
...
export default AddThirdPartyPurchase