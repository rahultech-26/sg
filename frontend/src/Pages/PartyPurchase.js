...
function PartyPurchase() {
    ...
    const getPurchaseData=()=>{
      axios.get(baseUrl + "partypurchase").then((res)=>
      {
    ...
    const delFn=(x)=>{
      axios.delete(baseUrl + "partypurchase/"+x).then(()=>getPurchaseData())
    }
              ...
              <div className="card">
                ...
                <div style={{ display: "flex", flexWrap: "wrap" }}>
                  <div className="mt-3 mb-3" style={{ paddingLeft: "20px" }}>
                      <a onClick={()=>navigate("/AddPartyPurchase")} >
                        <button
                          type="submit"
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="resaction">
                            <a onClick={()=>{localStorage.setItem("viewPartyPurchaseData",JSON.stringify(i));navigate("/ViewPartyPurchase")}} style={{ color: "#696cff", cursor: "Pointer" }}><i class="menu-icon tf-icons bx bx bx-show" /></a>
                          
                              <a onClick={()=>{localStorage.setItem("editPartyPurchaseData",JSON.stringify(i));navigate("/EditPartyPurchase")}} style={{ color: "#696cff", cursor: "Pointer" }}><i class="fa fa-edit" /></a> &nbsp;
