...
function Viewsale() {
  const localdata = localStorage.getItem("viewPartyPurchaseData")
  ...
  const delTrans=(x)=>{
    ...
    localStorage.setItem("partytransactionData", JSON.stringify(newsauda));
    axios.put(baseUrl+"partypurchase/" + saleData._id, {
  ...
  const addTrans=()=>{
    ...
    if(isEdit!==""){
      ...
      axios.put(baseUrl+"partypurchase/" + parsedata._id, {
        amtR: newList
      }).then(()=>{
        setAmountMode("")
        setPaymentDate("")
        ...
        setTRemark("")
        setIsEdit("")
        localStorage.setItem("partyData", JSON.stringify(newsauda));
        setSaleData(newsauda);
        setAmtRList(newList);
      })
    } else {
      ...
      <div className="layout-wrapper layout-content-navbar  ">
        <div className="layout-container">
          ...
          <div className="layout-page">
            ...
            <div className="container-xxl flex-grow-1 container-p-y">
              <h4 className="fw-bold py-3 mb-4">PARTY TRANSACTIONS</h4>
              {/* Striped Rows */}
              <div className="card">
