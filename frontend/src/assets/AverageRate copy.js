          ...
          <div className="layout-page">
            ...
            <div className="container-xxl flex-grow-1 container-p-y">
              ...
              <div style={{
                  width: "80%",margin:"10%"}}>
                  <label style={{
                  width: "50%",fontSize:30,fontWeight:"bold"}}>Average Rate</label>
               
                  <button style={{border:"1px solid grey",width:90,backgroundColor:"white",color:"black",borderRadius:3,width:"40%",height:60}}  disabled>...</button>
                </div>
                <div style={{
                  width: "80%",margin:"10%"}}>
                  <label style={{
                  width: "50%",fontSize:30,fontWeight:"bold"}}>Average Mill Rate</label>
